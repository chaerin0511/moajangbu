...
export default function SignupFlow({ signupAction }: { signupAction: (fd: FormData) => void }) {
    ...
    return (
      <div className="mt-10">
        ...
        <button
          ...
          className="mt-8 w-full flex items-center justify-center gap-2 rounded-xl py-4 font-semibold text-[15px] text-[#181600] shadow-sm transition active:translate-y-px hover:brightness-95"
        ...
        <p className="mt-8 text-center text-[13px] text-slate-500">
          이미 계정이 있나요?{' '}
          <Link href="/login" className="font-semibold text-slate-900 hover:underline">로그인</Link>
        </p>
      </div>
    );
  }
